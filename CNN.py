...
print("\nTraining the data...\n")
training_set = train_datagen.flow_from_directory('H:\CODE\data\train',
                                                 target_size=(64,64),
                                                 batch_size=12,
                                                 class_mode='categorical'
                                                 )

test_set = test_datagen.flow_from_directory('H:\CODE\data\test',
                                            target_size=(64,64),
                                            batch_size=12,
                                            class_mode='categorical'
                                            )
...
classifier.save(r"H:\CODE\visualizations\CNN.h5")
...
plt.ylabel('accuracy')
plt.legend()
plt.savefig(r"H:\CODE\visualizations\CNN_acc.png")
plt.show()
...
plt.ylabel('loss')
plt.legend()
plt.savefig(r"H:\CODE\visualizations\CNN_loss.png")
plt.show()
