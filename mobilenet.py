...
model.save("H:\CODE\visualizations\MobileNet.h5")
...
plt.ylabel('accuracy')
plt.legend()
plt.savefig(r"H:\CODE\visualizations\MobileNet_acc.png")
plt.show()
...
plt.ylabel('loss')
plt.legend()
plt.savefig(r"H:\CODE\visualizations\MobileNet_loss.png")
plt.show()
